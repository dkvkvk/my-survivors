...
一款用 **Godot 4 + GDScript** 开发的 2D 割草幸存者游戏。操控像素小忍者在被怪物淹没的荒野中求生：自动投掷手里剑、收集经验、升级三选一，看你能活多久。**全部美术素材为 CC0/OFL 可商用**。
...
**核心循环**：杀怪 → 捡经验宝石（会自动滚向你）→ 升级 → 三选一强化 → 变强 → 面对更强的怪。最高纪录（存活/击杀/等级）自动存本地，结算与主菜单可见。
...
save.gd           # ★ 最高纪录存档（user://records.json）
