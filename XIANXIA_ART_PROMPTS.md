...
### 2. `mech_slime_0.png` / `mech_slime_1.png` —— 阴泥（对应"机械史莱姆"位）
- **目标**：~49×24（生成大图我缩）
- **提示词（第 1 帧）**：

`@text
pixel art game enemy, a blob of corpse-mud: grey-green muddy slime lump, low wide body,
surface pocked with small dim ghost-fire glow spots (pale green), few dripping tendrils,
two faint dim eye-spots, shambling forward, seen from the side,
color palette: dark ink-blue night, sickly green (#4F7A4A) body, pale green glow spots,
...
- **第 2 帧**：同上 + `squashed mid-step pose, mud spreading at the base, glow spots shifting`
