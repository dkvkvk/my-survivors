...
const LIST := [
	{
		...
		"max_level": 5,
		"passive": "gun",
		"skills": ["shuriken_burst", "dash_blade"],
	...
	},
	{
		...
		"max_level": 5,
		"passive": "orbit_blade",
		"skills": ["blade_storm", "ring_release"],
		"upgrade_material": "scrap",
		"base_cost": 6,
		"kills_per_level": 40,
	...
	},
	{
		...
		"max_level": 5,
		"passive": "boomerang",
		"skills": ["whirlwind_volley", "pierce_shuttle"],
		"upgrade_material": "scrap",
		"base_cost": 6,
		"kills_per_level": 40,
		"desc": "被动：掷梭回旋，去而复返\n去程返程各伤一次",
	},
	{
		...
		"max_level": 5,
		"passive": "mine",
		"skills": ["thunder_net", "detonate_all"],
		"upgrade_material": "crystal",
		"base_cost": 5,
		"kills_per_level": 40,
		"desc": "被动：布符于地，妖至即爆\n范围杀伤，可囤积",
